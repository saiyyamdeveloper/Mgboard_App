...
| 4 | **toolbar-project** | Gboard keyboard toolbar / suggestion strip — access points, capacity, overflow, panels | ✅ **Implemented** — `toolbar/` (pure model) + `ui/KeyboardToolbar.kt` + `ui/ToolbarPanels.kt`; 17 access points, 14 Gboard config flags, 11 panels (emoji/symbols/clipboard/edit-menu fully live), 146 JVM assertions | `RESEARCH.md`, `IMPLEMENTATION.md` |
